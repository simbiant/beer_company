...
<div class="mainBlock" style="padding-top: 10px;">
	...
	<form action="/add_c" method="post">
        @csrf
        <label style="font-size: 20px; padding-top: 10px;">Додати компанію</label><br/><br/>
        <label style="font-size: 20px; padding-top: 10px;"> Назва</label><br/>
		<input type="text" style="font-size: 20px; margin: 10px 0 0 20px; width: 500px;" name="name" placeholder="Назва..." />
